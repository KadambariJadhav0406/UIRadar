...
function AdminNavbar() {
  ...
  return (
    <div>
      <Navbar variant="dark" expand="lg" className="px-5" style={{ border: '2px solid black',backgroundColor:"#d8cdc7" }}>
        <Container fluid>
        <Navbar.Brand as={NavLink} to="/admin/addengineer" className="d-flex align-items-center text-decoration-none">
        <span style={{color:"#ff7e5f", fontSize:"2.0rem"}}>
          UIRadar
        </span>
      </Navbar.Brand>
